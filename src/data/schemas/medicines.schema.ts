...
export const medicineSchema = z.object({
  ...
  supplierId: z.string().min(1, { message: "Nhà cung cấp là bắt buộc" }),
  ...
  variants: z.object({
    ...
    stockStatus: z.nativeEnum(StockStatus, { message: "Trạng thái là bắt buộc" }),
  ...
  usageguide: z.object({
    ...
    directions: z
      .array(z.string())
      .min(1, { message: "Hướng dẫn sử dụng là bắt buộc" }),
    precautions: z
      .array(z.string())
      .min(1, { message: "Các lưu ý là bắt buộc" }),
  }),

...
export function InvoicesTableToolbar({ table }: InvoicesTableToolbarProps) {
  ...
  return (
    <motion.div 
      ...
      className="flex flex-col gap-3 sm:flex-row sm:items-center justify-between p-1.5 mb-4 bg-white dark:bg-slate-950 rounded-lg shadow-sm border border-emerald-50 dark:border-emerald-900/20"
    >
      <div className="flex flex-1 flex-col sm:flex-row items-center gap-2.5">
        <div className="relative w-full sm:w-64 md:w-80">
          ...
          <Input
            ...
            className="w-full bg-white dark:bg-slate-900 pl-9 shadow-sm border border-emerald-100 dark:border-emerald-800/40 rounded-lg focus-visible:ring-emerald-500 transition-all duration-200"
          />
          {table.getState().globalFilter && (
            <Button
              variant="ghost"
              size="sm"
              className="absolute right-1 top-1.5 h-6 w-6 p-0 text-emerald-500 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-full transition-colors"
          ...
          {isFiltered && (
            ...
            >
              <Button
                variant="ghost"
                size="sm"
                className="h-9 px-3 text-emerald-700 dark:text-emerald-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 hover:text-rose-600 dark:hover:text-rose-400 transition-colors rounded-md"
                onClick={() => {

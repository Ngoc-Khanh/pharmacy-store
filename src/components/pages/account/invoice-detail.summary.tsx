...
import { Calendar, CheckCircle2, Clipboard, Download, Info, Receipt, ShieldCheck } from "lucide-react";
...
const InfoItem = ({
  ...
  <div className={cn("bg-gray-50/80 dark:bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-gray-100 dark:border-gray-700", className)}>
...
export function InvoiceDetailSummary({ invoice }: InvoiceSummaryProps) {
        ...
        <CardContent className="p-5 space-y-5">
          ...
          <InfoItem label="Phương thức thanh toán">
            <div className="flex items-center">
              ...
              <div>
                <span className="text-gray-900 dark:text-gray-100 font-semibold block">{getPaymentMethodLabel(invoice.paymentMethod)}</span>
                <span className="text-xs text-gray-500 dark:text-gray-400">Thanh toán an toàn & bảo mật</span>
              </div>
            </div>
          </InfoItem>

  ...
  return (
    <section className="w-full py-12 md:py-20 bg-gradient-to-br from-green-50 via-blue-50/50 to-purple-50/30 dark:from-green-950/40 dark:via-blue-950/30 dark:to-purple-950/20 overflow-hidden relative">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 right-0 w-96 h-96 bg-green-200/20 dark:bg-green-900/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-blue-200/20 dark:bg-blue-900/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container px-4 md:px-6 relative max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 bg-yellow-50/50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-200 dark:border-yellow-800">
            ...
            <div className="rounded-2xl bg-white/90 dark:bg-gray-900/90 shadow-xl border border-gray-100 dark:border-gray-800 backdrop-blur-sm overflow-hidden h-full">
              <div className="p-6 h-full flex flex-col">
                ...
                <div className="flex-1 space-y-4 overflow-y-auto pr-2 mb-6 min-h-[300px] max-h-[400px]">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl rounded-tl-sm p-4 max-w-[85%] shadow-sm">
                  ...
                  <div className="ml-auto bg-green-100 dark:bg-green-900/60 rounded-2xl rounded-tr-sm p-4 max-w-[85%] shadow-sm">
                    <p className="text-sm leading-relaxed">Tôi bị đau đầu và sốt nhẹ, nên uống thuốc gì?</p>
                  </div>

                  <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl rounded-tl-sm p-4 max-w-[90%] shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="relative">
                    <Input
                      ...
                      className="pr-16 pl-4 py-4 bg-gray-50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-green-500/40 focus:border-green-500 transition-all duration-200 text-sm shadow-inner h-12"
                    />
                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                      <Button
                        size="icon"
                        className="h-8 w-8 bg-green-500 hover:bg-green-600 text-white rounded-lg shadow-md transition-all duration-200 group"
                      >

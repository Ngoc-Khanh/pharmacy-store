import { Details, SupplierResponse, UsageGuide } from "@/data/interfaces";
...
export function MedicineDetailTabs({ activeTab, onTabChange, details, usageguide, supplier, categoryName, updatedAt }: MedicineDetailTabsProps) {
  return (
    <motion.div
      className="mb-12"
